...
public class Nest5 {
	public static void main(String args[]) {
		//static method call
		OuterClass5.StaticInnerClass.showStatic();
		//instance methods can of course not be called statically 
		//OuterClass3.StaticInnerClass.display();
		
		OuterClass5.StaticInnerClass innerStatic = new OuterClass5.StaticInnerClass();
		//should not do this, call static methods statically
		innerStatic.showStatic();
		//innerStatic method called on an instance 
		innerStatic.displayStatic();
		
		OuterClass5.InstanceInnerClass5 innerInstance = new OuterClass5().new InstanceInnerClass5();
