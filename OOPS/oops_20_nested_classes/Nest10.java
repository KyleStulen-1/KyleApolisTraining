...
class OuterClass10 {
	...
	class InstanceInnerClass10 {
		...
		void displayY_Values() {
			...
			//data shadowing
			System.out.println("Instance variable y: " + OuterClass10.this.y + " in outer class");
		}
	}
...
public class Nest10 {
	public static void main(String args[]) {
		//static method call
		OuterClass10.StaticInnerClass.showStatic();
		//instance methods can of course not be called statically 
		//OuterClass3.StaticInnerClass.display();
		
		OuterClass10.StaticInnerClass innerStatic = new OuterClass10.StaticInnerClass();
		...
		OuterClass10.InstanceInnerClass10 innerInstance = new OuterClass10().new InstanceInnerClass10();
		innerInstance.showInstance();
		innerInstance.display();
		innerInstance.displayY_Values();
		
		OuterClass10 outerClass = new OuterClass10();
		outerClass.methodWithClassInside();
		OuterClass10.static_methodWithClassInside();
